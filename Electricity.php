...
<section class="shop container">
    ...
    <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` where category_type = 'Electricity'") or die('query failed');
    ...
    ?>
        <div class="product-box">
            ...
            <form action="" method="post">
                <img src="uploaded_img/<?php echo $fetch_products['product_image']; ?>" alt="" class="product-img">
                <h2 class="product-title"><?php echo $fetch_products['product_title']; ?></h2>
                <p class="descreption"><?php echo $fetch_products['pr_description']; ?> </p>
                <span class="product-price"><?php echo $fetch_products['product_price']; ?>Dhs</span>
